...
if story == True:
  ...
  if thingy2 == False:#introduction
    ...
    while idk43:
      ...
      if fisht == '1':
        ...
        while fishing:
          ...
          if p == '':
            print(f'{Green}You got a {OFISH}!{White}')
            time.sleep(1)
            any_key()
            clear()
            durability_ffr-=1
            fish_guest.append(OFISH)
            if guest == True:
              pass
            else:
              dataset = fish_guest
        ...
        fishing=True
        while fishing:
          RFISH=random.choice(rfish)
          print('River Fishing:')
          print('Press ENTER to fish and enter BACK to exit out of fishing')
          p = input('> ').lower()

          if p == '':
            print(f'{Green}You got a {RFISH}!{White}')
            time.sleep(1)
            any_key()
            clear()
            durability_ffr-=1
            fish_guest.append(RFISH)
            if guest == True:
              pass
            else:
              dataset = fish_guest
            ...
            if durability_ffr <= 0:
              fishing=False
              print(f'{Red}Your fishing rod broke!{White}')
              time.sleep(2)
              any_key()
              clear()
            else:
        ...
        fishing=True
        while fishing:
          LFISH=random.choice(lfish)
          print('Lake Fishing:')
          print('Press ENTER to fish and enter BACK to exit out of fishing')
          p = input('> ').lower()

          if p == '':
            print(f'{Green}You got a {LFISH}!{White}')
            time.sleep(1)
            any_key()
            clear()
            durability_ffr-=1
            fish_guest.append(LFISH)
            if guest == True:
              pass
            else:
              dataset = fish_guest
    ...
    while idk:#not in order btw
      ...
      if dataset == 'Meets DJ KK and sleeps':
        ...
        continue#goes through the path again
  ...
  if game==True:
    ...
    while login_signup:
      ...
      if ls_menu == '1':
        ...
        if name_ro == 'o':
          ...
          thingy2=False
          print(f'{Blue}{username}{White} it is! What a wonderful name! Welcome to {Green}Animal Crossing {Orange}REPLIT v.1!{White}')
          dataset = username
          outputFile = 'username.env'
          fw = open(outputFile, 'wb')
          pickle.dump(dataset, fw)
        ...
        print('You will continue as GUEST. Are you sure you want to continue? y/n')
        yn_guest = input('> ').lower()
        clear()
        ...
        if yn_guest == 'y':
          thingy2=False
          username='GUEST'
          print(Green+'Okie Dokie GUEST! Welcome Aboard!'+White)
          time.sleep(2)
          any_key()
          clear()
          guest=True
    ...
    clear()#just in case
    fish_get=[]
    fish_list=['Bitterling','Pale Chub','Crucian Carp','Dace','Soft-shelled Turtle','Snapping Turtle','Freshwater Goby','Loach','Bluegill','Yellow Perch','Black Bass','Tilapia','Pike','Sweetfish','Cherry Salmon','Char','Golden Trout','String Fish','Salmon','King Salmon','Mitten Crab','Guppy','Nibble Fish','Angel Fish','Betta','Neon Tetra','Rainbowfish','Piranha','Arowana','Dorado','Arapaima','Saddled Bichir','Sturgeon','Sea Butterfly','Sea Horse','Clown Fish','Butterfly Fish','Surgeonfish','Zebra Turkeyfish','Napoleonfish','Blowfish','Puffer Fish','Anchovy','Horse Mackerel','Sea Bass','Barred Knifejaw','Red Snapper','Dab','Olive Flounder','Squid','Moray Eel','Ribbon Eel','Ocean Sunfish','Ray','Saw Shark','Hammerhead Shark','Great White Shark','Whale Shark','Suckerfish','Football Fish','Oarfish','Barreleye','Coelacanth']
    shirts=['Collarless Shirt','Outdoor Shorts','Tailored Jacket','Paper Bag','Rounded Beard','Sunglasses','Pilot Shades','Jesters Mask']
    shirt_get=[]
    villagers=['Truffles','Spork','Peggy','Hugh','Agnes','Rasher','Maggie','Lucy','Kevin','Gala','Curly','Cobb','Chops','Boris','Del','Sly','Gayle','Drago','Boots','Alli','Alfonso','Apollo','Avery','Amelia','Pierce','Frank','Buzz','Sterling','Keaton','Peewee','Violet','Hans','Boyd','Rocket','Boone','Rilla','Louise','Al','Cesar','Bea','Walker','Shep','Portia','Marcel','Maddie','Mac','Bones','Bones','Cookie','Lucky','Cherry','Daisy','Butch','Biskit','Benjamin','Goldie','Marcie','Walt','Rooney','Kitt','Matilda','Carrie','Sylvia','Astrid','Roald','Tex','Sprinkle','Puck','Iggly','Gwen','Friga','Aurora','Cube','Flo','Hopper','Wade','Boomer','Admiral','Jacob','Piper','Robin','Sparo','Midge','Peck','Lucha','Jitters','Twiggy','Jay','Anchovy','Jacques','Anabelle','Snooty','Pango','Antonio','Olaf','Annalisa','Cyrano','Anicotti','Chadder','Rod','Limberg','Rizzo','Candi','Dora','Brocollo','Penelope','Bella','Bettina','Bree','Mouse','Samson','Greta','Soleil','Rodney','Flurry','Apple','Hamphrey','Hamlet','Graham','Clay']
    villager_get=[]
    while game_activate:
      print(f'{Orange}Animal {Green}Crossing!{White}')
      print(f'{italic}Note:{reset} There is no saving feature in game mode\n')
      print('\t[1] Fish\n\t[2] Wardrobe\n\t[3] Stats\n\t[4] Villagers\n\t[5] Explore')
      menug = input('> ')
      clear()
      ...
      if menug == '1':
        ...
        while fishing:
          ...
          print(f'{Blue}Fishing:{White}')
          print('Press ENTER to fish and BACK to go back')
          fish=input('> ').lower()
          clear()

          if fish == '':
            print(f'{Green}You got a {FISH}!{White}')
            time.sleep(1)
            any_key()
            clear()
            fish_get.append(FISH)
        ...
        wardrobing=True
        while wardrobing:
          shirt1=random.choice(shirts)
          shrit2=random.choice(shirts)
          shirt3=random.choice(shirts)
          hum=True
          while hum:
            if shirt1 == shirt2:
              shirt2=random.choice(shirts)
            elif shirt1 == shirt3:
              shirt3=random.choice(shirts)
            elif shirt2 == shirt3:
              shirt3=random.choice(shirts)
              ...
              hum=False
          print(f'{Orange}Wardrobe:{White}')
          print(f'Current Clothes:\n[1] {shirt1}\n[2] {shirt2}\n[3] {shirt3}\n[4] Back')
          wardrobe=input('> ')
          clear()

          if wardrobe == '1':
            print(f'{Green}You wore {shirt1}!{White}')
            time.sleep(2)
            any_key()
            clear()
            shirt_get.append(shirt1)
            
          elif wardrobe == '2':
            print(f'{Green}You wore {shirt2}!{White}')
            time.sleep(2)
            any_key()
            clear()
            shirt_get.append(shirt2)

          elif wardrobe == '3':
            print(f'{Green}You wore {shirt3}!{White}')
            time.sleep(2)
            any_key()
            clear()
            shirt_get.append(shirt3)
